                      ...
                      <div class="col-sm-12">
                        <div class="card-box table-responsive">
                          ...
                          <table id="datatable-keytable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                  <?php
                                    if($users->getListofUsers() == false){

                                    }
                                    else{
                                    foreach($users->getListofUsers() as $users){ ?>
                    ...
                    <form method="post" action="../includes/users.inc.php">
                        ...
                        <label for="user_email">Restriction</label>
                            ...
                            <div class="form-group  col-md-12 ml-3">
                                ...
                                <input type="checkbox" class="custom-control-input" id="user_management" value="user_management" name="subadmin_sttngs[]">
                                <label class="custom-control-label" for="user_management">User Management</label>
                            </div>

                           <div class="form-group col-md-6 ml-3">
                              
                                <input type="checkbox" class="custom-control-input" id="child_profile" value="child_profile" name="subadmin_sttngs[]">
                                <label class="custom-control-label" for="child_profile">Child Profile</label>
                            </div>

                            <div class="form-group col-md-12 ml-3">
                              
                                <input type="checkbox" class="custom-control-input" id="scheduler" value="scheduler" name="subadmin_sttngs[]">
                            ...
                            <div class="form-group col-md-6 ml-3">
                                ...
                                <input type="checkbox" class="custom-control-input" id="reports" value="reports" name="subadmin_sttngs[]">
                            ...
                            <div class="form-group   col-md-12 ml-3">
                                <input type="checkbox" class="custom-control-input" id="utilities" value="utilities" name="subadmin_sttngs[]">
